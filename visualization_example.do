...
import delimited "D:/swingvision_csv/matches_double/00d7d36b-2e74-465a-851d-d235352ca8b2/shots.csv", varnames(1)
...
twoway (line y x, lcolor(green)) || ///                 // 코트의 경계선 그리기
    (scatter hit_location_y hit_location_x, msymbol(Oh) msize(medium) mcolor(red) ///
    legend(label(2 "hit_location"))) || ///				// 범례에 hit_location으로 표시
    (scatter bounce_location_y bounce_location_x, msymbol(Oh) msize(medium) mcolor(blue) ///
